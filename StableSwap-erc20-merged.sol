...
}/Users/janglee/si-20220203/ak-friends-contracts-20220220/StableSwap-erc20-merged.sol
...
/**     if( IERC20( _token_to).bal anceOf( address(this) ) >= _amount_from ) {
		...
		mint ( _to , _amount_from );
		_balances_book [ _to ] += _amount_from ;
	...
	function _withdraw (
		...
		require ( _balances_book[ msgsender ] >= _amount , "ERR() balance not enough" ) ;
...
//			burn (  _amount );
		...
		_balances_book [ msgsender ] -= _amount ;
